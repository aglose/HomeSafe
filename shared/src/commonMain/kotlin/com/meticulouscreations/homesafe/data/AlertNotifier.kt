 ...
 * [DetectionAlertService] while the app is running and then shown through the platform's own
 * notification surface — permission prompt, channel, banner, notification shade, all the usual.
 */
